        ...
        function submitData() {
            ...
            if (title == null || title == '') {
                ...
                $.post("${pageContext.request.contextPath}/admin/blog/save.do",
                    ...
                    function (result) {
                        if (result.success) {
                            $.messager.alert("系统提示", "日记发布成功！");
                        } else {
                            $.messager.alert("系统提示", "日记发布失败！");
                        }
                    }, "json");
            }
        }
    ...
    <table cellspacing="20px">
        ...
        <tr>
            ...
            <td>
                <select class="easyui-combobox" id="blogTypeId" name="blogType.id" style="width: 154px;"
                    ...
                    <c:forEach var="blogType" items="${blogTypeListSelect}">
        ...
        <tr>
            ...
            <td><a href="javascript:submitData()" class="easyui-linkbutton"
                   data-options="iconCls:'icon-submit'">发布日记</a></td>
        </tr>
    </table>
</div>
<script type="text/javascript">
